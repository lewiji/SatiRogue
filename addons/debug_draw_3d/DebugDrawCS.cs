...
public class DebugDrawCS : Node {
   ...
   /// </summary>
   public static bool RecallToSingleton {
      get => debug_draw_3d != null ? (bool) debug_draw_3d.Get("recall_to_singleton") : default;
      set => debug_draw_3d?.Set("recall_to_singleton", value);
   }
   ...
   public static bool DebugEnabled {
      get => debug_draw_3d != null ? (bool) debug_draw_3d.Get("debug_enabled") : default;
      set => debug_draw_3d?.Set("debug_enabled", value);
   }

   /// <summary>
   /// Freezing 3d debugging instances
   /// </summary>
   public static bool Freeze3dRender {
      get => debug_draw_3d != null ? (bool) debug_draw_3d.Get("freeze_3d_render") : default;
      set => debug_draw_3d?.Set("freeze_3d_render", value);
   }

   /// <summary>
   /// Debug for debug...
   /// </summary>
   public static bool VisibleInstanceBounds {
      get => debug_draw_3d != null ? (bool) debug_draw_3d.Get("visible_instance_bounds") : default;
      set => debug_draw_3d?.Set("visible_instance_bounds", value);
   }
   ...
   public static bool UseFrustumCulling {
      get => debug_draw_3d != null ? (bool) debug_draw_3d.Get("use_frustum_culling") : default;
      set => debug_draw_3d?.Set("use_frustum_culling", value);
   }
   ...
   /// Usable for editor.
   /// </summary>
   public static bool ForceUseCameraFromScene {
      get => debug_draw_3d != null ? (bool) debug_draw_3d.Get("force_use_camera_from_scene") : default;
      set => debug_draw_3d?.Set("force_use_camera_from_scene", value);
   }

   /// <summary>
   /// Base offset for all graphs
   /// </summary>
   public static Vector2 GraphsBaseOffset {
      get => debug_draw_3d != null ? (Vector2) debug_draw_3d.Get("graphs_base_offset") : default;
      set => debug_draw_3d?.Set("graphs_base_offset", value);
   }

   /// <summary>
   /// Layers on which the geometry will be displayed
   /// </summary>
   public static int GeometryRenderLayers {
      get => debug_draw_3d != null ? (int) debug_draw_3d.Get("geometry_render_layers") : default;
      set => debug_draw_3d?.Set("geometry_render_layers", value);
   }

   /// <summary>
   /// Position of text block
   /// </summary>
   public static int TextBlockPosition {
      get => debug_draw_3d != null ? (int) debug_draw_3d.Get("text_block_position") : default;
      set => debug_draw_3d?.Set("text_block_position", value);
   }

   /// <summary>
   /// Offset from the corner selected in 'text_block_position'
   /// </summary>
   public static Vector2 TextBlockOffset {
      get => debug_draw_3d != null ? (Vector2) debug_draw_3d.Get("text_block_offset") : default;
      set => debug_draw_3d?.Set("text_block_offset", value);
   }

   /// <summary>
   /// Text padding for each line
   /// </summary>
   public static Vector2 TextPadding {
      get => debug_draw_3d != null ? (Vector2) debug_draw_3d.Get("text_padding") : default;
      set => debug_draw_3d?.Set("text_padding", value);
   }

   /// <summary>
   /// How long text remain shown after being invoked.
   /// </summary>
   public static float TextDefaultDuration {
      get => debug_draw_3d != null ? (float) debug_draw_3d.Get("text_default_duration") : default;
      set => debug_draw_3d?.Set("text_default_duration", value);
   }
   ...
   public static Color TextForegroundColor {
      get => debug_draw_3d != null ? (Color) debug_draw_3d.Get("text_foreground_color") : default;
      set => debug_draw_3d?.Set("text_foreground_color", value);
   }
   ...
   public static Color TextBackgroundColor {
      get => debug_draw_3d != null ? (Color) debug_draw_3d.Get("text_background_color") : default;
      set => debug_draw_3d?.Set("text_background_color", value);
   }

   /// <summary>
   /// Custom text Font
   /// </summary>
   public static Font TextCustomFont {
      get => debug_draw_3d != null ? (Font) debug_draw_3d.Get("text_custom_font") : default;
      set => debug_draw_3d?.Set("text_custom_font", value);
   }

   /// <summary>
   /// Default color of line with hit
   /// </summary>
   public static Color LineHitColor {
      get => debug_draw_3d != null ? (Color) debug_draw_3d.Get("line_hit_color") : default;
      set => debug_draw_3d?.Set("line_hit_color", value);
   }

   /// <summary>
   /// Default color of line after hit
   /// </summary>
   public static Color LineAfterHitColor {
      get => debug_draw_3d != null ? (Color) debug_draw_3d.Get("line_after_hit_color") : default;
      set => debug_draw_3d?.Set("line_after_hit_color", value);
   }
   ...
   public static Viewport CustomViewport {
      get => debug_draw_3d != null ? (Viewport) debug_draw_3d.Get("custom_viewport") : default;
      set => debug_draw_3d?.Set("custom_viewport", value);
   }
   ...
   public static CanvasItem CustomCanvas {
      get => debug_draw_3d != null ? (CanvasItem) debug_draw_3d.Get("custom_canvas") : default;
      set => debug_draw_3d?.Set("custom_canvas", value);
   }
   ...
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawLineHit(Vector3 start,
      Vector3 end,
      Vector3 hit,
      bool is_hit,
      float hit_size = 0.25f,
      Color? hit_color = null,
      Color? after_hit_color = null,
      float duration = 0f) {
      debug_draw_3d?.Call("draw_line_hit", start, end, hit, is_hit, hit_size, hit_color == null ? empty_color : hit_color,
         after_hit_color == null ? empty_color : after_hit_color, duration);
   }
   ...
   /// <param name="after_hit_color">Color of line after hit position</param>
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawLineHitOffset(Vector3 start,
      Vector3 end,
      bool is_hit,
      float unit_offset_of_hit = 0.5f,
      float hit_size = 0.25f,
      Color? hit_color = null,
      Color? after_hit_color = null,
      float duration = 0f) {
      debug_draw_3d?.Call("draw_line_hit_offset", start, end, is_hit, unit_offset_of_hit, hit_size,
         hit_color == null ? empty_color : hit_color, after_hit_color == null ? empty_color : after_hit_color, duration);
   }
   ...
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawArrowLine(Vector3 a,
      Vector3 b,
      Color? color = null,
      float arrow_size = 0.5f,
   ...
   /// <param name="absolute_size">Is the 'arrowSize' absolute or relative to the length of the line?</param>
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawArrowRay(Vector3 origin,
      Vector3 direction,
      float length,
      Color? color = null,
      float arrow_size = 0.5f,
      bool absolute_size = false,
      float duration = 0f) {
      debug_draw_3d?.Call("draw_arrow_ray", origin, direction, length, color == null ? empty_color : color, arrow_size, absolute_size,
         duration);
   }
   ...
   /// <param name="absolute_size">Is the 'arrowSize' absolute or relative to the length of the line?</param>
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawArrowPath(Vector3[] path,
      Color? color = null,
      float arrow_size = 0.75f,
      bool absolute_size = true,
      float duration = 0f) {
   ...
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawPointPath(Vector3[] path,
      float size = 0.25f,
      Color? points_color = null,
      Color? lines_color = null,
      float duration = 0f) {
      debug_draw_3d?.Call("draw_point_path", path, size, points_color == null ? empty_color : points_color,
         lines_color == null ? empty_color : lines_color, duration);
   }
   ...
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawGrid(Vector3 origin,
      Vector3 x_size,
      Vector3 y_size,
      Vector2 subdivision,
      Color? color = null,
   ...
   /// <param name="is_centered">Draw lines relative to origin</param>
   /// <param name="duration">Duration of existence in seconds</param>
   public static void DrawGridXf(Transform transform,
      Vector2 subdivision,
      Color? color = null,
      bool is_centered = true,
      float duration = 0f) {
...
#pragma warning disable IDE0060 // Remove unused parameter
	...
	public static void DrawAabb(AABB aabb, Color? color = null, float duration = 0f) {}
	public static void DrawAabbAb(Vector3 a, Vector3 b, Color? color = null, float duration = 0f) {}
	public static void DrawLineHit(Vector3 start, Vector3 end, Vector3 hit, bool is_hit, float hit_size = 0.25f, Color? hit_color =
 null, Color? after_hit_color = null, float duration = 0f) {}
	public static void DrawLineHitOffset(Vector3 start, Vector3 end, bool is_hit, float unit_offset_of_hit = 0.5f, float hit_size =
 0.25f, Color? hit_color = null, Color? after_hit_color = null, float duration = 0f) {}
	public static void DrawLine(Vector3 a, Vector3 b, Color? color = null, float duration = 0f) {}
	public static void DrawLines(Vector3[] lines, Color? color = null, float duration = 0f) {}
	public static void DrawRay(Vector3 origin, Vector3 direction, float length, Color? color = null, float duration = 0f) {}
	public static void DrawLinePath(Vector3[] path, Color? color = null, float duration = 0f) {}
	public static void DrawArrow(Transform transform, Color? color = null, float duration = 0f) {}
	public static void DrawArrowLine(Vector3 a, Vector3 b, Color? color = null, float arrow_size = 0.5f, bool absolute_size =
 false, float duration = 0f) {}
	public static void DrawArrowRay(Vector3 origin, Vector3 direction, float length, Color? color = null, float arrow_size =
 0.5f, bool absolute_size = false, float duration = 0f) {}
	public static void DrawArrowPath(Vector3[] path, Color? color = null, float arrow_size = 0.75f, bool absolute_size =
 true, float duration = 0f) {}
	public static void DrawPointPath(Vector3[] path, float size = 0.25f, Color? points_color = null, Color? lines_color =
 null, float duration = 0f) {}
	public static void DrawSquare(Vector3 position, float size = 0.2f, Color? color = null, float duration = 0f) {}
	public static void DrawPoints(Vector3[] points, float size = 0.25f, Color? color = null, float duration = 0f) {}
	public static void DrawPosition(Transform transform, Color? color = null, float duration = 0f) {}
	public static void DrawGizmo(Transform transform, Color? color = null, bool is_centered = false, float duration = 0f) {}
	public static void DrawGrid(Vector3 origin, Vector3 x_size, Vector3 y_size, Vector2 subdivision, Color? color = null, bool is_centered =
 true, float duration = 0f) {}
	public static void DrawGridXf(Transform transform, Vector2 subdivision, Color? color = null, bool is_centered = true, float duration =
 0f) {}
	public static void DrawCameraFrustum(Camera camera, Color? color = null, float duration = 0f) {}
	public static void DrawCameraFrustumPlanes(Array camera_frustum, Color? color = null, float duration = 0f) {}
	public static void BeginTextGroup(string group_title, int group_priority = 0, Color? group_color = null, bool show_title = true) {}
...
#pragma warning restore IDE0060 // Remove unused parameter
      ...
      public bool ShowTitle {
         get => orig_ref != null ? (bool) orig_ref.Get("show_title") : default;
         set => orig_ref?.Set("show_title", value);
      }
      ...
      public bool FrametimeMode {
         get => orig_ref != null ? (bool) orig_ref.Get("frametime_mode") : default;
         set => orig_ref?.Set("frametime_mode", value);
      }

      /// <summary>
      /// Draw a graph line aligned vertically in the center
      /// </summary>
      public bool CenteredGraphLine {
         get => orig_ref != null ? (bool) orig_ref.Get("centered_graph_line") : default;
         set => orig_ref?.Set("centered_graph_line", value);
      }

      /// <summary>
      /// Sets the text visibility *GraphTextFlags*
      /// </summary>
      public int ShowTextFlags {
         get => orig_ref != null ? (int) orig_ref.Get("show_text_flags") : default;
         set => orig_ref?.Set("show_text_flags", value);
      }
      ...
      public int BufferSize {
         get => orig_ref != null ? (int) orig_ref.Get("buffer_size") : default;
         set => orig_ref?.Set("buffer_size", value);
      }
      ...
      public Color LineColor {
         get => orig_ref != null ? (Color) orig_ref.Get("line_color") : default;
         set => orig_ref?.Set("line_color", value);
      }
      ...
      public Color TextColor {
         get => orig_ref != null ? (Color) orig_ref.Get("text_color") : default;
         set => orig_ref?.Set("text_color", value);
      }
      ...
      public Color BackgroundColor {
         get => orig_ref != null ? (Color) orig_ref.Get("background_color") : default;
         set => orig_ref?.Set("background_color", value);
      }
      ...
      public Color BorderColor {
         get => orig_ref != null ? (Color) orig_ref.Get("border_color") : default;
         set => orig_ref?.Set("border_color", value);
      }
      ...
      public string TextSuffix {
         get => orig_ref != null ? (string) orig_ref.Get("text_suffix") : "";
         set => orig_ref?.Set("text_suffix", value);
      }
      ...
      public Font CustomFont {
         get => orig_ref != null ? (Font) orig_ref.Get("custom_font") : default;
         set => orig_ref?.Set("custom_font", value);
      }
