...
public class InitOptions : GdSystem {
   private static readonly PackedScene OptionsScene = GD.Load<PackedScene>("res://src/Ecs/Menu/Nodes/Options.tscn");
   private Options? _options;
   private readonly string _configPath = "user://satirogue.cfg";
   ...
   private ConfigFile GetOrCreateConfigFile() {
   ...
   private static void SetInitialEnvironmentSetting(Option option, ConfigFile cfg, WorldEnvironment worldEnv) {
   ...
   private static object GetInitialConfigVal(ConfigFile cfg, Option option, WorldEnvironment worldEnv, string[] splitKeys) {
   ...
   private void OnOptionChanged(Option.OptionType optionLocation, Dictionary keyValue) {
