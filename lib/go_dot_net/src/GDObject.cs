...
public class GDObject : Reference {
   /// <summary>
   ...
   public static T FromData<T>(Dictionary<string, object?> data) where T : GDObject {
   ...
   public static Dictionary<string, object?> ToData<T>(T obj) where T : GDObject {
      return new GDLog(obj.GetType().Name).Run(() => JObject.FromObject(obj).ToObject<Dictionary<string, object?>>()!);
   }
   ...
   public static T FromStringData<T>(Dictionary<string, string> data) where T : GDObject {
      return JObject.FromObject(data).ToObject<T>()!;
   }
   ...
   /// <typeparam name="T">Type of object to serialize.</typeparam>
   /// <returns>Dictionary data.</returns>
   public static Dictionary<string, string> ToStringData<T>(T obj) where T : GDObject {
      return new GDLog(obj.GetType().Name).Run(() => JObject.FromObject(obj).ToObject<Dictionary<string, string>>()!);
   }
   ...
   public static HashSet<string> GetKeys<T>(T obj) where T : GDObject {
      return JObject.FromObject(obj).Properties().Select(prop => prop.Name).ToHashSet();
   }
   ...
   public override bool Equals(object obj) {
      return obj is GDObject other && this == other;
   }
